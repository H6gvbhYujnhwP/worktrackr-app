...
const mapLine = (r) => ({
  ...
  buyInCost: r.cost_price,   // buy-in ex VAT, per unit (from the IDYQ quote)
  profit: r.line_profit,     // line profit ex VAT (from the IDYQ quote)
  type: r.line_type,         // 'one_off' | 'annual' | 'monthly' …

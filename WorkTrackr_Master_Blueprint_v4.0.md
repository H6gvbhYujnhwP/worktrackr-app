...
These tables form the foundation of the multi-tenant system.
...
| `email_intake_logs`     | A complete log of every email processed by the intake system.            |
...
```sql
-- WorkTrackr Cloud Database Schema v1.2

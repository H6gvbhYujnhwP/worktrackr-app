# WorkTrackr — CRM, Ordering & Commission Roadmap (v2.6)
...
**Build position:** Phases 0–8 plus the **Phase 8.1 Sales UX consolidation (v2.1)** are built, plus the **v2.5 Users role selector + role-based home screens** and the **v2.6 per-role navigation gating (engineers delivery-only, no profit)**. The redesign is complete end-to-end. No phase is in progress; only the deferred non-blockers below remain.
...
**Stale docs — do NOT trust:** `docs/ROADMAP.md`, `docs/APP-STATE.md` and `docs/database_schema.md` are pre-redesign (April). Trust **this roadmap (v2.6)** and the **code** over them.

...
**Current build stamp: `2026-07-01.datetime-picker-all`** (shown faintly in the sidebar footer when the sidebar is expanded — use it to confirm a deploy went live).
